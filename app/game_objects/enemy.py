...
class Enemy(Entity):
    def __init__(self, pos, path, groups, shoot, player, collision_sprites):
        ...
        # Đặt player lên trên các khối nền bằng cách kiểm tra va chạm
    ...
    def get_status(self):
        # Đảm bảo rằng enemy luôn nhìn về phía player
    ...
    def check_fire(self):
        ...
        # Kiểm tra xem player có trong tầm nhìn theo chiều ngang
